 ...
 * detail fields — those would bloat `renderJobs.inputJson` and the Gemini
 * payload.
 */
export const MAX_RENDER_PROMPT_LENGTH = 4000;

/**
 * Hard cap on the stylist-question length sent to Gemini. Matches the client
 ...
 * stops showing a spinner forever. Generous vs. a typical Gemini render
